package com.seoulmilk.be.auth.filter;

import com.seoulmilk.be.auth.application.JwtService;
import com.seoulmilk.be.auth.exception.InvalidTokenException;
import com.seoulmilk.be.auth.exception.errorcode.JwtErrorCode;
...
public class JwtAuthenticationProcessingFilter extends OncePerRequestFilter {
    ...
    public void saveAuthentication(com.seoulmilk.be.auth.domain.User user) {
